...
st.session_state.aba_sheet = 'Configurações Natal'

st.session_state.titulo = 'Dias Livres por Voo - Natal'

st.session_state.titulo_2 = 'Dias Livres por Hotel - Natal'

st.session_state.titulo_3 = 'Dias Livres Acumulados por Hotel - Natal'

st.session_state.titulo_4 = 'Aproveitamento Dias Livres - Natal'
